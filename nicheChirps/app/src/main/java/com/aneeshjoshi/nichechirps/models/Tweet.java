...
public class Tweet extends Model implements Serializable{
	...
	public static Tweet fromJson(JSONObject object){
		...
		try {
            ...
            tweet.createdTimestamp = TimeUtils.getTimeInMillisFromCreatedString(tweet.createdAt);
            //tweet.user
    ...
    public static void saveAll(List<Tweet> tweetList) {
    ...
    public static List<Tweet> findRecent() {
        return new Select()
                .from(Tweet.class)
